...
<!-- Cafe Menu -->
<div id="menu" class="go" data-parallax="scroll" data-image-src="<?php $cafe_menu_image = get_option('cafe_menu_image'); echo esc_url($cafe_menu_image); ?>">
    ...
    <div class="container mx-auto tm-container py-24 sm:py-48">
        <div class="tm-item-container sm:ml-auto sm:mr-12 mx-auto sm:px-0 px-4">
            <div class="bg-white bg-opacity-80 p-12 pb-14 rounded-xl mb-5">
                <h2 class="mb-6 tm-text-green text-4xl font-medium"><?php echo esc_html(get_theme_mod('about_heading', 'About our cafe')); ?></h2>
                <p class="mb-6 text-base leading-8"><?php echo esc_html(get_theme_mod('about_content', '')); ?></p>
                <p class="text-base leading-8">
                    <?php echo wp_kses(get_theme_mod('support_content', 'If you wish to <a rel="nofollow" href="https://www.tooplate.com/contact" target="_parent">support us</a>, please make a little donation via PayPal. That would be very helpful. Another way is to tell your friends about Tooplate website. Thank you.'), array('a' => array('rel' => true, 'href' => true, 'target' => true))); ?>
                </p>
            </div>
    ...
    <div class="container mx-auto tm-container pt-24 pb-48 sm:py-48">
        <div class="flex flex-col lg:flex-row justify-around items-center lg:items-stretch">
            <div class="flex-1 rounded-xl px-10 py-12 m-5 bg-white bg-opacity-80 tm-item-container">
                <h2 class="text-3xl mb-6 tm-text-green"><?php echo esc_html(get_theme_mod('contact_us_title')); ?></h2>
                <p class="mb-6 text-lg leading-8"><?php echo esc_html(get_theme_mod('contact_us_description')); ?></p>
            <p class="mb-10 text-lg">
            <span class="block mb-2">Tel: <a href="tel:<?php echo esc_attr(get_theme_mod('telephone_number', '010-020-0340')); ?>" class="hover:text-yellow-600 transition"><?php echo esc_html(get_theme_mod('telephone_number', '010-020-0340')); ?></a></span>
            <span class="block">Email: <a href="mailto:<?php echo esc_attr(get_theme_mod('email_address', 'info@company.com')); ?>" class="hover:text-yellow-600 transition"><?php echo esc_html(get_theme_mod('email_address', 'info@company.com')); ?></a></span>
        </p>
                            <div class="text-center">
                <a href="<?php echo esc_url(get_theme_mod('google_maps_link', '')); ?>" class="inline-block text-white text-2xl pl-10 pr-12 py-6 rounded-lg transition tm-bg-green">
